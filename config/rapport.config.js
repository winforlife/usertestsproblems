...
//
// Ce fichier contrôle intégralement le contenu et l'apparence du rapport email.
...
export const CONFIG = {
  ...
  // ── Identité de marque ────────────────────────────────────────────────────
  brand: {
    name:    "The New Game of Life",
    author:  "Christophe Jouret",
    email:   "christophe@thenewgol.com",
    website: "thenewgol.com",
    year:    "2026",
  ...
  palette: {
    ...
    rule:       "#C8973A",   // alias gold — filets, accents
    cream:      "#F7F3EE",   // texte clair sur fond sombre
    warm:       "#C8B898",   // texte italique sur fond sombre
    white:      "#FFFFFF",
    grey:       "#8A9AAA",   // texte secondaire
    error:      "#C0392B",   // score faible
    green:      "#27AE60",   // score élevé
    blue:       "#3A7BD5",   // boîte Développement Professionnel
    purple:     "#8E44AD",   // boîte Développement Personnel
    // SVG radar
    svgFullFill:   "#0E1E30",
    svgFullStroke: "#1E3555",
    svgGrid:       "#162A45",
  },
  ...
  intro: {
    paragraph1:
      ...
      "positionnement The New Game of Life. Il ne constitue pas un jugement sur vos " +
  ...
  // Couleurs alignées avec AXES dans App.jsx
  dimensions: {
    D1: {
      id:    "D1",
  ...
  sectionII: {
    intro1:
      ...
      "position actuelle sur les six dimensions (zone dorée), la perspective de " +
      "développement accessible à court terme (zone pointillée), et le potentiel " +
      "théorique complet de chaque dimension (fond sombre à 5/5).",
    intro2:
